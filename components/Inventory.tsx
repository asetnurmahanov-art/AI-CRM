...
const Inventory: React.FC<InventoryProps> = ({ products, setProducts, onPromote }) => {
                   ...
                   <>
                    ...
                    <div className="flex gap-3">
                      <button 
                        ...
                        className={`flex-1 py-4 md:py-5 rounded-[2rem] font-black uppercase text-[10px] tracking-widest shadow-lg spring-press text-white transition-colors ${
                          selectedProduct.status === 'available' ? 'bg-amber-500 shadow-amber-200' : 
